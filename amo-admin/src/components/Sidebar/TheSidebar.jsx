...
const TheSidebar = () => {
    ...
    return (
        <div id="Menu_mis">
            ...
            <NavLink to="/manageuser" id="Manage_User_mi"
            ...
            <NavLink to="/b" id="Manage_Asset_mi"
            ...
            <NavLink to="/c" id="Manage_Assignment_miz"
            ...
            <NavLink to="/d" id="Request_for_Returning_miw"
            ...
            <NavLink to="/e" id="Report_mit" className="Report navitem"
